        ...
        <Page title="Why AngryUsers">
            <div className="row">
                <div className="col-md-8">
                    ...
                    <p>You may be wondering what would be the need to share bad experiences on AngryUsers, or to what end. Well, there are some cogent reason why you may want to 
                    ...
                    <ul>
                        <li>AngryUsers strives to push as far as possible, any complaint posted on it, so that both the defaulting organisation, their clients/customers and prospects 
                            ...
                            about it. Hence, the angry user gets result eventually</li>
                        <li>We are aware some organisations have customer support unit, but we also know that for some organisations, reaching them on phone or getting a reply via email 
                            could be frustrating. In such case, the angry user isn’t heard yet and hence the complaint or issue would not be registered or resolved at all or it would 
                            linger longer than necessary. AngryUsers’ platform would in this case be a good alternative lodge the complaint</li>  
